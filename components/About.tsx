            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-6 sm:p-10">
                ...
                <p className="mt-5 text-slate-700 leading-relaxed">
                  Jakadevi Homestay is a relaxed, family-friendly{" "}
                  <span className="font-medium">homestay in Malvan</span>{" "}
                  designed for slow mornings, beach afternoons, and easy
                  evenings. Expect clean rooms, warm hospitality, and everything
                  you need for a simple{" "}
                  <span className="font-medium">coastal stay in Konkan</span>.
                </p>
              ...
              <div className="relative min-h-[260px] lg:min-h-full">
                <Image
                  ...
                  alt="Coastal homestay in Malvan, Konkan"
                  fill
